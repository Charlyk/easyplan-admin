...
export const Statuses = [
  ...
  },
  {
    ...
    color: '#4bba01',
    icon: <IconCheckMark />,
    statusIcon: <DoneIcon fill='#4bba01' />,
    manual: true,
    isSchedule: true,
  },
  {
  ...
  },
  {
    ...
    color: '#fc6c85',
    icon: <IconXPerson />,
    statusIcon: <IconClear fill='#fc6c85' />,
    manual: true,
    isSchedule: true,
  },
  {
    ...
    color: '#fc2847',
    icon: <IconXPerson />,
    statusIcon: <IconClear fill='#fc2847' />,
    manual: true,
    isSchedule: true,
  },
  {
  ...
  },
  {
    ...
    color: '#1df914',
    icon: <IconCreditCard />,
    statusIcon: <DoneAllIcon fill='#1df914' />,
    manual: false,
    isSchedule: true,
  },
  {
  ...
  },
  {
    ...
    color: '#bab86c',
    icon: <IconFree />,
    statusIcon: <DoneAllIcon fill='bab86c' />,
    manual: false,
    isSchedule: true,
  },
  {
