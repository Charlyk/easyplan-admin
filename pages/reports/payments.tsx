...
const Payments: NextPage<PaymentsPageProps> = ({ query }) => {
  return (
    <MainComponent currentPath='/reports/payments'>
      <PaymentsComponent query={query} />
    </MainComponent>
  );
};

export default connect((state: ReduxState) => state)(Payments);
